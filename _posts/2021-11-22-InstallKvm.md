...
- 内存建议3G起步，并且需要**勾选虚拟化引擎**
  ...
  ![image-20211121221252313](/images/image-20211121221252313.png)

  

- 在linux中安装win10,硬盘需要45G，如果够了就不需要再增加。因为我刚开始设置不够，所以加装了一块硬盘，加装后要记得去在linux上挂载

  ![image-20211121233453791](/images/image-20211121233453791.png)
...
![image-20211121221558251](/images/image-20211121221558251.png)

**2.**



![image-20211121221608307](/images/image-20211121221608307.png)



**3.**

![image-20211121221623286](/images/image-20211121221623286.png)

**4.**

![image-20211121221639029](/images/image-20211121221639029.png)
...
![image-20211121234500736](/images/image-20211121234500736.png)
...
![image-20211121234959450](/images/image-20211121234959450.png)
...
![image-20211121235409569](/images/image-20211121235409569.png)

**3.3** 分区号这些都默认

![image-20211121235451873](/images/image-20211121235451873.png)

**3.4** 输入p，可以看到默认为sdb1

![image-20211121235757971](/images/image-20211121235757971.png)



**3.5** 再输入w，写入操作

![image-20211121235537881](/images/image-20211121235537881.png)
...
![image-20211122000043172](/images/image-20211122000043172.png)
